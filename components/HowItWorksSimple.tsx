...
const steps = [
  {
    ...
    description: "לוחצים על \"התחילו בחינם\", יוצרים חשבון תוך דקה ומגדירים את סוג ההתמחות שלכם.",
    icon: (
  ...
  },
  {
    ...
    description: "מגדירים זמני פגישות, ומתחילים לצבור היסטוריה טיפולית מסודרת, מהרגע הראשון.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="how-it-works" className="section-padding bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg text-text-secondary text-center max-w-2xl mx-auto mb-12 animate-on-scroll delay-1">
          פחות מ-5 דקות מהרישום לפגישה ראשונה מתועדת
        </p>
