  ...
  return (
    <section id="testimonials" className="section-padding bg-gradient-to-br from-primary via-primary-light to-secondary">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4 animate-on-scroll">
          {heContent.socialProof.title}
        </h2>
        <p className="text-lg text-white/80 text-center max-w-2xl mx-auto mb-12 animate-on-scroll delay-1">
          {heContent.socialProof.subtitle}
        </p>

        <div className="max-w-3xl mx-auto mb-10 animate-on-scroll delay-2">
          <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-10 border border-white/20">
            ...
            <div className="max-w-xl mx-auto">
              <p className="text-white text-lg md:text-xl leading-relaxed mb-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 animate-on-scroll delay-3">
