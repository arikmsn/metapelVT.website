...
export const heContent = {
  hero: {
    ...
    subtitle:
      "המערכת לומדת ומייצרת עבורך סיכומי פגישות אוטומטיים, תזכורות, תכנית טיפולית, הכל במקום אחד. כדי שהמטופלים שלך יקבלו ליווי מקצועי לאורך כל הדרך.",
  ...
  forWhom: {
    ...
    items: [
      {
        title: "מטפלים פרטיים בגישות שונות",
        description:
          "בכל גישה (CBT / אומנות / ריפוי בעיסוק ועוד) תקבלו תמונה מסודרת של כל התהליך.",
      },
      {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "אחרי כל פגישה מקליטים כמה נקודות קצרות, והמערכת מייצרת סיכום מסודר, משימות ותכנית טיפולית מלאה.",
      },
    ],
  ...
  security: {
    ...
    subtitle:
      "מידע טיפולי הוא הדבר הרגיש ביותר שיש.\nבנינו את המערכת מהיסוד עם אבטחה וסודיות מלאה.",
    items: [
      {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "בוחרים מסלול בתשלום, באופן פשוט, ברור ומשתלם. במידה ולא, אפשר לעצור ללא שום קנס ולהעתיק את כל המידע שצברתם. ללא שום הפתעות.",
      },
      {
