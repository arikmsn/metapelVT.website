  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 bg-background">
      <div className="container mx-auto px-4">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-primary text-center mb-4">
          {heContent.socialProof.title}
        </h2>
        <p className="text-center text-primary/70 mb-10 md:mb-14 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
          {heContent.socialProof.subtitle}
        </p>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 max-w-5xl mx-auto mb-10 md:mb-14">
          {heContent.socialProof.testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-primary/80 mb-4 text-sm leading-relaxed">{testimonial.text}</p>
