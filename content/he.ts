...
export const heContent = {
  hero: {
    ...
    subtitle:
      "מערכת בינה מלאכותית שעוזרת לך ללוות מטופלים ומתאמנים ביום‑יום: סיכומי פגישות, משימות ותזכורות – בלי ללכת לאיבוד בין כל התהליכים.",
    ...
    items: [
      {
        title: "מטפלים פרטיים",
        description:
          "מי שעובדים אחד על אחד, בזום או בחדר טיפולים – ורוצים תמונה מסודרת על כל תהליך.",
      },
      {
        title: "קליניקות וצוותים טיפוליים",
        description:
          "מספר מטפלים, הרבה מטופלים – וכל המידע מרוכז, נגיש ומעודכן במקום אחד.",
      },
      {
        title: "קואצ'רים, מנחים ויועצים",
        description:
          "ליווי אישי או קבוצתי, מעקב ברור אחרי כל אדם או קבוצה – בלי להסתמך על הזיכרון.",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description:
          "אחרי כל מפגש מוסיפים בקצרה תמלול, הקלטה או כמה נקודות – והמערכת מייצרת סיכום ברור ומסודר.",
      },
      {
        title: "הכנה לפגישה הבאה",
        description:
          "לפני כל מפגש תראה את עיקרי הדברים, מה הוחלט, מה הוטל כמשימה – ותגיע ממוקד ומוכן.",
      },
      {
  ...
  socialProof: {
    ...
    subtitle:
      "מטפלים, קואצ'רים ומנחים לקחו חלק בפיתוח – כדי שהמערכת תרגיש חלק טבעי מהעבודה, לא עוד מערכת כבדה שמפריעה.",
    testimonials: [
      {
  ...
  security: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "המידע במערכת לא משמש לפרסום, שיווק או מכירה. הוא נשאר ביןך לבין האנשים שאתה מלווה.",
      },
    ],
  },
